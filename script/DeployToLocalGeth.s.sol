...
// To run this:
/* forge script script/DeployToLocalGeth.s.sol \
...
contract DeployEthMultiVault is Script {
    ...
    address public DEVELOPER = 0x07baA707F61c89F6eB33c8Cb948c483c9b387084; // Developer Wallet
    ...
    function run() external {
        ...
        bondingCurveRegistry = new BondingCurveRegistry(address(DEVELOPER));
