 ...
 * @title  EthMultiVault
 * @author 0xIntuition
 * @notice This contract includes `badVar` variable, which was added to intentionally mess up the storage layout
 ...
 */
contract IncorrectStorageLayoutEthMultiVault is
    IEthMultiVault,
    Initializable,
    ...
    PausableUpgradeable
{
    ...
    /// @dev Variable introduced intentionally to mess up the storage layout and to confirm that the script is working
    string public badVar;
