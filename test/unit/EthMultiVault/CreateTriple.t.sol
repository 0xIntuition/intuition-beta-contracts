...
contract CreateTripleTest is EthMultiVaultBase, EthMultiVaultHelpers {
    ...
    function testCreateTriple() external {
        ...
        uint256 id = ethMultiVault.createTriple{value: testDepositAmount}(
            subjectId,
            predicateId,
            objectId
        );
        ...
        assertEq(vaultTotalAssets(id), testDepositAmount - getProtocolFee(id) - getTripleCreationFee() - getMinShare());
